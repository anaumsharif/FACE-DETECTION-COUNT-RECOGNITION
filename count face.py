...
# creating BYTETracker instance
byte_tracker = sv.ByteTrack(track_thresh=0.25, track_buffer=30, match_thresh=0.8, frame_rate=30)

# creating VideoInfo instance
video_info = sv.VideoInfo.from_video_path(SOURCE_VIDEO_PATH)

# creating frame generator
generator = sv.get_video_frames_generator(SOURCE_VIDEO_PATH)

# creating PolygonZone instance
zone = sv.PolygonZone(polygon=polygon, frame_resolution_wh=(video_info.width, video_info.height))

# creating box annotator
box_annotator = sv.BoxAnnotator(thickness=4, text_thickness=4, text_scale=2)

colors = sv.ColorPalette.default()

# creating instance of BoxAnnotator
